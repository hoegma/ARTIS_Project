...
Each device generates and stores data, leaving behind a digital footprint. 
This footprint can be used as evidence in subsequent investigations and consists of GPS coordinates, text messages, wearables and more.
...
ML models can be used to search for complex patterns and anomalies in large data sets.
...
Attackers can attempt to disrupt the training process or draw conclusions about training data by reading the clients' parameters.
\newline
...
That is why a decentralized approach using FL is one way to connect the data islands between organizations.
\newline
