...
A fake face detection model is developed using FL to distinguish between real and fake faces.
...
The 140k real-fake faces dataset was used, which consists of 70,000 real faces and 70,000 fake faces with a image size of 256px~\cite{tunguz2020_140kreal_fake_faces}.
...
The output is a 1-dimensional vector with probabilities indicating whether the input image is a fake or real face.
...
Because of the high accuracy this approach is used as a benchmark for comparing central fake face detection with fake face detection using FL.
...
Training was performed with a batch size of 32 over 30 epochs.
\newline
