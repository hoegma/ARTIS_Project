...
To assess model interpretability, we applied SHAP (SHapley Additive exPlanations) to both the Baseline and Federated models. Figure~\ref{fig:shap_comparison} illustrates the SHAP value distributions for key features across both models.